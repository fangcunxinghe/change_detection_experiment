...
###################### Data and Model ########################
from models.network.SemiModel import SemiModel as Net
...
def main():
    ...
    train_set = RS.RS('train', random_crop=True, crop_nums=10, crop_size=args['crop_size'],
